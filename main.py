...
east_north_turn = (
    "The stone walls curve at a right angle, a doorway to the north and tp the east."
)
east_south_turn = (
    "The stone walls curve at a right angle, a doorway to the south and to the east."
)
west_north_turn = (
    "The stone walls curve at a right angle, a doorway to the north and to the west."
)
...
goblin_defeat = (
    "You fell the lowly goblin with your attacks, putting it out of its misery."
)
